...
> **Wichtige Änderung (PA4/PA8):** Die internen Eingänge **PA4** und **PA8** sind nur bis **1.1V** nutzbar. Damit sind sie für SMT50 nur für den Temperaturkanal geeignet (typisch 0.2..1.0V). Temperaturen oberhalb von ca. +60 °C (1.1V) sind über PA4/PA8 nicht messbar. Für SMT50-Bodenfeuchte (bis 3V) muss auf ADS1115-Kanäle umgeklemmt werden.
